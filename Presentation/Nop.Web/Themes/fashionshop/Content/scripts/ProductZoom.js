    ...
    $.extend(featuredimagezoomer, {
        ...
        init: function ($img, options) {
            ...
            if (setting.cursorshade) {
                $cursorshade = $('<div class="cursorshade" style="visibility:hidden;position:absolute;background:url(Themes/fashionshop/content/images/zoom-hover.gif);left:0;top:0;z-index:' + basezindex + ';" />').css({
